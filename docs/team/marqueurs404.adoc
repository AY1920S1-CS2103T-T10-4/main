...
TimeBook is a scheduling application that aims to help busy NUS undergraduates keep track of the schedules of the user and his or her friends. It also can find the common free time and venues among the user and his or her friends.
...
//*** Wrote tests for features I implemented (Pull requests https://github.com[#36], https://github.com[#38])
** Documentation:
